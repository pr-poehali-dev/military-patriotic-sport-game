...
Задание объявляется торжественно, с паузами для нагнетания напряжения.`,
  ...
  },
  {
    ...
    rulesSenior: [
      "Расшифровать слово по таблице замены букв — шифр «Номер в алфавите». Таблица на карточке: А=1 Б=2 В=3 Г=4 Д=5 Е=6 Ё=7 Ж=8 З=9 И=10 Й=11 К=12 Л=13 М=14 Н=15 О=16 П=17 Р=18 С=19 Т=20 У=21 Ф=22 Х=23 Ц=24 Ч=25 Ш=26 Щ=27 Ъ=28 Ы=29 Ь=30 Э=31 Ю=32 Я=33. Зашифрованное слово на карточке: 4 — 6 — 18 — 16 — 11 → правильный ответ: Г-Е-Р-О-Й (ГЕРОЙ). Дети смотрят в таблицу и называют букву для каждой цифры",
      "Составить ответное зашифрованное послание: зашифровать слово ОТРЯД цифрами по той же таблице → правильно: 16 — 20 — 18 — 33 — 5",
      "Передать фразу «Рубеж взят!» флажковым семафором",
      "Запомнить и воспроизвести трёхзначный код: 4 — 7 — 2",
    ],
    hostScript: [
